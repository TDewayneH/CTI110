...
def main():
    ...
    #Ask user their age
    age = int(input("What is your age padawan, if you are younger than 1 round up also how are you using a computer?!?: "))
    ...
    #If user is between 1 and 13
        ...
        print("You are a teenager and might be able to fight the darkside for a time!")
